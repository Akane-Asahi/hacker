...
const Terminal = ({ theme, setTheme }) => {
  ...
  const [title, setTitle] = React.useState('Akane_Asahi Terminal');
...
class Field extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      fieldHistory: [{ text: 'root access gained!' }, { text: 'Type HELP to see the full list of commands.', hasBuffer: true }],
      userInput: '',
      isMobile: false
    };
    ...
    this.recognizedCommands = [{
      command: 'help',
      purpose: 'Provides help information for Akane_Asahi Terminal commands.'
    },
    {
      command: 'date',
    ...
    // {
    //   command: 'cmd',
    //   purpose: 'Starts a new instance of the Akane Asahi Terminal.'
    // },
    {
      command: 'theme',
      purpose: 'Sets the color scheme of the Akane Asahi Terminal.',
      help: [
        'THEME <L|LIGHT|D|DARK> [-s, -save]',
        'Sets the color scheme of the Akane Asahi Terminal.',
        '',
    ...
    },
    {
      command: 'whoami',
      isMain: true,
      purpose: 'Displays basic information about M.'
    },
    {
      command: 'experience',
      isMain: true,
      purpose: 'Displays information about experience.'
    },
    {
      command: 'skills',
      isMain: true,
      purpose: 'Displays information about skills as a developer and hacker.'
    },
    {
      command: 'contact',
      isMain: true,
      purpose: 'Displays contact information for M.'
    },
    {
      command: 'projects',
      isMain: true,
      purpose: 'Displays information about what projects M has done in the past.'
    },
    {
      command: 'project',
      isMain: true,
    ...
    {
      command: 'title',
      purpose: 'Sets the window title for the Akane Asahi Terminal.',
      help: [
        'TITLE <INPUT>',
        'Sets the window title for the Akane Asahi Terminal.',
        '',
        'INPUT....................The title you want to use for the Akane Asahi Terminal window.']
    },
  ...
  handleInputExecution(cmd, params = [], flags = []) {
    if (cmd === 'help') {
      ...
      return this.setState(state => ({
        fieldHistory: [...state.fieldHistory, {
          text: [
            ...
            'BSc. Computer Engineering.............BRAC University',
      ...
      return this.setState(state => ({
        fieldHistory: [...state.fieldHistory, {
          text: [
            'Email: ceo@hacker.black',
            'Website: akaneasahi.com',
            'LinkedIn: /in/mosfaiulalam',
            'GitHub: @Akane-Asahi',
            'Medium: @theakaneasahi'],
          hasBuffer: true
        }]
      }));
      ...
      return this.setState(state => ({
        fieldHistory: [...state.fieldHistory, {
          text: [
            'Ai for Email Classification',
            'Link: http://ieeexplore.ieee.org/document/8255404/',
            '',
            'RentNRide, BD Car Rental Solution',
            'Link: https://rentnride.com.bd',
            '',
            'Portfolio: Akane Asahi',
            'Link: https://akaneasahi.com',
            '',
            'Portfolio: Hacker Black',
            'Link: https://hacker.black',
          ],
          hasBuffer: true
        }]
      }));
      ...
      if (params.length === 1) {
        const projects = [{
          title: 'aiemail',
          live: 'http://ieeexplore.ieee.org/document/8255404/'
        },
        {
          title: 'rentnride',
          live: 'https://rentnride.com.bd/'
        },
        {
          title: 'akaneasahi',
          live: 'https://akaneasahi.com'
        },
        {
          title: 'hackerblack',
          live: 'https://hacker.black'
        },
        {
...
const Text = ({ input, isCommand, isError, hasBuffer }) => /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/
  React.createElement("div", null,
    isCommand && /*#__PURE__*/React.createElement("div", { id: "query" }, "MAT C:\\Users\\root>"), /*#__PURE__*/
...
const UserText = ({ input, theme }) => /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/
  React.createElement("div", { id: "query" }, "MAT C:\\Users\\root>"), /*#__PURE__*/
